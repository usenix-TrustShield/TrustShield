# all functions in this script is provided by the paper https://doi.org/10.1016/j.future.2022.12.003 and please cite them for the refence
import torch
import numpy as np
import pandas as pd
...
def get_averaged_weights_without_outliers_strict_condition(model_dict, iteration_distance, device):
    ...
    # print("Chosen # clients: " +str(len(chosen_clients)))
...
def strict_condition_without_outliers_set_averaged_weights_as_main_model_weights_and_update_main_model(main_model,
                                                                                                       ...
                                                                                                       device):
    """
    Sets the main_model weights to the accepted weights by ARFED.
    """
...
def calculate_lower_and_upper_limit(data, factor):
    """
    Calculates the upper and lower limits of given data.
    """
